...
En java, on produit souvent un *jar* (java archive) ou un *war* (web archive - ie, une application web).
...
This build could be faster, please consider using the Gradle Daemon: http://gradle.org/docs/2.4/userguide/gradle_daemon.html <3> 
----
