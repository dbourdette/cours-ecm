...
*git* semble avoir pris le pas sur tous les autres système.
...
Il permet de répondre a des organisations complexes avec des commiters tout autour du monde.
...
Il existe au moins une alternative, moins riche : GitLab.
****
...
Afin de pouvoir pousser vers le serveur distant, il nous reste donc a relier notre master local au origin/master de github
...
http://www.amazon.fr/Pro-Git-Scott-Chacon/dp/1484200772[Pro Git] est un très bon livre qui couvre tous ces sujets.
****
