...
Spring MVC ne brille pas pour sa *convention over configuration* (en partie à cause de JEE et en partie à cause de Spring).
...
NOTE: Il est possible de faire la même configuration en java.
...
http://docs.spring.io/spring/docs/current/spring-framework-reference/html/mvc.html#mvc-ann-requestbody[`@RequestBody`] permet de convertir le body de la requête HTTP en paramètre du handler
...
http://docs.spring.io/spring/docs/current/spring-framework-reference/html/mvc.html#mvc-ann-responsebody[`@ResponseBody`] permet de convertir le type de retour du handler en body de la réponse HTPP.
...
Il y a usages possible pour cette annotation.
...
Voir http://docs.spring.io/spring/docs/current/spring-framework-reference/html/mvc.html#mvc-ann-modelattrib-methods
...
Voir http://docs.spring.io/spring/docs/current/spring-framework-reference/html/mvc.html#mvc-ann-modelattrib-method-args
