...
NOTE: Le développeur de cette application a utilisé https://bower.io/[bower] afin de récupérer les librairies front (bootstrap et jquery)
https://yarnpkg.com/fr/[yarn] serait une alternative plus récente et plus riche.
