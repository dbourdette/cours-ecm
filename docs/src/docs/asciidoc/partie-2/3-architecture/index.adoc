...
http://tomcat.apache.org/[Tomcat] est un serveur web pouvant lancer des applications web java.
...
[.float-group]
--
image::yarn.png[width="100",role="left"]

https://yarnpkg.com/[Yarn] est un gestionnaire de dépendances pour librairies front.
